...
- [Live Demo Link](https://math-magicians-5nnc.onrender.com/)
...
```sh
  cd my-folder
  git clone https://github.com/andrianarivo/math-magicians.git
```
...
You can deploy this project using your own `Github Page`
...
I would like to thank Microverse for the materials
